...
var wasmImports = {
  Vh: _JsToDef_RegisterCallbacks,
  Uh: _JsToDef_RemoveCallbacks,
  b: ___assert_fail,
  Th: ___syscall__newselect,
  Sh: ___syscall_accept4,
  Rh: ___syscall_bind,
  Qh: ___syscall_connect,
  Ph: ___syscall_dup3,
  ...
  Mh: ___syscall_ioctl,
  Lh: ___syscall_listen,
  Kh: ___syscall_mkdirat,
  Z: ___syscall_openat,
  Jh: ___syscall_poll,
  Ih: ___syscall_readlinkat,
  Hh: ___syscall_recvfrom,
  Gh: ___syscall_renameat,
  Fh: ___syscall_rmdir,
  Eh: ___syscall_sendto,
  ta: ___syscall_socket,
  Dh: ___syscall_stat64,
  Y: ___syscall_unlinkat,
  Ah: __emscripten_get_now_is_monotonic,
  zh: __emscripten_lookup_name,
  yh: __emscripten_system,
  xh: __emscripten_throw_longjmp,
  za: __gmtime_js,
  ya: __localtime_js,
  xa: __mktime_js,
  wh: __tzset_js,
  G: _abort,
  vh: _dmDeviceJSFreeBufferSlots,
  uh: _dmDeviceJSOpen,
  th: _dmDeviceJSQueue,
  sh: _dmGetDeviceSampleRate,
  ...
  kh: _emscripten_get_heap_max,
  ra: _emscripten_get_now,
  jh: _emscripten_glActiveTexture,
  ih: _emscripten_glAttachShader,
  hh: _emscripten_glBeginQuery,
  gh: _emscripten_glBeginQueryEXT,
  fh: _emscripten_glBeginTransformFeedback,
  eh: _emscripten_glBindAttribLocation,
  dh: _emscripten_glBindBuffer,
  ch: _emscripten_glBindBufferBase,
  bh: _emscripten_glBindBufferRange,
  ah: _emscripten_glBindFramebuffer,
  $g: _emscripten_glBindRenderbuffer,
  _g: _emscripten_glBindSampler,
  Zg: _emscripten_glBindTexture,
  Yg: _emscripten_glBindTransformFeedback,
  Xg: _emscripten_glBindVertexArray,
  Wg: _emscripten_glBindVertexArrayOES,
  Vg: _emscripten_glBlendColor,
  Ug: _emscripten_glBlendEquation,
  Tg: _emscripten_glBlendEquationSeparate,
  Sg: _emscripten_glBlendFunc,
  Rg: _emscripten_glBlendFuncSeparate,
  Qg: _emscripten_glBlitFramebuffer,
  Pg: _emscripten_glBufferData,
  Og: _emscripten_glBufferSubData,
  Ng: _emscripten_glCheckFramebufferStatus,
  Mg: _emscripten_glClear,
  Lg: _emscripten_glClearBufferfi,
  Kg: _emscripten_glClearBufferfv,
  Jg: _emscripten_glClearBufferiv,
  Ig: _emscripten_glClearBufferuiv,
  Hg: _emscripten_glClearColor,
  Gg: _emscripten_glClearDepthf,
  Fg: _emscripten_glClearStencil,
  Eg: _emscripten_glClientWaitSync,
  Dg: _emscripten_glColorMask,
  Cg: _emscripten_glCompileShader,
  Bg: _emscripten_glCompressedTexImage2D,
  Ag: _emscripten_glCompressedTexImage3D,
  zg: _emscripten_glCompressedTexSubImage2D,
  yg: _emscripten_glCompressedTexSubImage3D,
  xg: _emscripten_glCopyBufferSubData,
  wg: _emscripten_glCopyTexImage2D,
  vg: _emscripten_glCopyTexSubImage2D,
  ug: _emscripten_glCopyTexSubImage3D,
  tg: _emscripten_glCreateProgram,
  sg: _emscripten_glCreateShader,
  rg: _emscripten_glCullFace,
  qg: _emscripten_glDeleteBuffers,
  pg: _emscripten_glDeleteFramebuffers,
  og: _emscripten_glDeleteProgram,
  ng: _emscripten_glDeleteQueries,
  mg: _emscripten_glDeleteQueriesEXT,
  lg: _emscripten_glDeleteRenderbuffers,
  kg: _emscripten_glDeleteSamplers,
  jg: _emscripten_glDeleteShader,
  ig: _emscripten_glDeleteSync,
  hg: _emscripten_glDeleteTextures,
  gg: _emscripten_glDeleteTransformFeedbacks,
  fg: _emscripten_glDeleteVertexArrays,
  eg: _emscripten_glDeleteVertexArraysOES,
  dg: _emscripten_glDepthFunc,
  cg: _emscripten_glDepthMask,
  bg: _emscripten_glDepthRangef,
  ag: _emscripten_glDetachShader,
  $f: _emscripten_glDisable,
  _f: _emscripten_glDisableVertexAttribArray,
  Zf: _emscripten_glDrawArrays,
  Yf: _emscripten_glDrawArraysInstanced,
  Xf: _emscripten_glDrawArraysInstancedANGLE,
  Wf: _emscripten_glDrawArraysInstancedARB,
  Vf: _emscripten_glDrawArraysInstancedEXT,
  Uf: _emscripten_glDrawArraysInstancedNV,
  Tf: _emscripten_glDrawBuffers,
  Sf: _emscripten_glDrawBuffersEXT,
  Rf: _emscripten_glDrawBuffersWEBGL,
  Qf: _emscripten_glDrawElements,
  Pf: _emscripten_glDrawElementsInstanced,
  Of: _emscripten_glDrawElementsInstancedANGLE,
  Nf: _emscripten_glDrawElementsInstancedARB,
  Mf: _emscripten_glDrawElementsInstancedEXT,
  Lf: _emscripten_glDrawElementsInstancedNV,
  Kf: _emscripten_glDrawRangeElements,
  Jf: _emscripten_glEnable,
  If: _emscripten_glEnableVertexAttribArray,
  Hf: _emscripten_glEndQuery,
  Gf: _emscripten_glEndQueryEXT,
  Ff: _emscripten_glEndTransformFeedback,
  Ef: _emscripten_glFenceSync,
  ...
  zf: _emscripten_glFramebufferTextureLayer,
  yf: _emscripten_glFrontFace,
  xf: _emscripten_glGenBuffers,
  wf: _emscripten_glGenFramebuffers,
  vf: _emscripten_glGenQueries,
  uf: _emscripten_glGenQueriesEXT,
  tf: _emscripten_glGenRenderbuffers,
  sf: _emscripten_glGenSamplers,
  rf: _emscripten_glGenTextures,
  qf: _emscripten_glGenTransformFeedbacks,
  pf: _emscripten_glGenVertexArrays,
  of: _emscripten_glGenVertexArraysOES,
  nf: _emscripten_glGenerateMipmap,
  mf: _emscripten_glGetActiveAttrib,
  lf: _emscripten_glGetActiveUniform,
  kf: _emscripten_glGetActiveUniformBlockName,
  jf: _emscripten_glGetActiveUniformBlockiv,
  hf: _emscripten_glGetActiveUniformsiv,
  gf: _emscripten_glGetAttachedShaders,
  ff: _emscripten_glGetAttribLocation,
  ef: _emscripten_glGetBooleanv,
  df: _emscripten_glGetBufferParameteri64v,
  cf: _emscripten_glGetBufferParameteriv,
  bf: _emscripten_glGetError,
  af: _emscripten_glGetFloatv,
  $e: _emscripten_glGetFragDataLocation,
  _e: _emscripten_glGetFramebufferAttachmentParameteriv,
  Ze: _emscripten_glGetInteger64i_v,
  Ye: _emscripten_glGetInteger64v,
  Xe: _emscripten_glGetIntegeri_v,
  We: _emscripten_glGetIntegerv,
  Ve: _emscripten_glGetInternalformativ,
  Ue: _emscripten_glGetProgramBinary,
  Te: _emscripten_glGetProgramInfoLog,
  Se: _emscripten_glGetProgramiv,
  Re: _emscripten_glGetQueryObjecti64vEXT,
  Qe: _emscripten_glGetQueryObjectivEXT,
  Pe: _emscripten_glGetQueryObjectui64vEXT,
  Oe: _emscripten_glGetQueryObjectuiv,
  Ne: _emscripten_glGetQueryObjectuivEXT,
  Me: _emscripten_glGetQueryiv,
  Le: _emscripten_glGetQueryivEXT,
  Ke: _emscripten_glGetRenderbufferParameteriv,
  Je: _emscripten_glGetSamplerParameterfv,
  ...
  Ee: _emscripten_glGetShaderiv,
  De: _emscripten_glGetString,
  Ce: _emscripten_glGetStringi,
  Be: _emscripten_glGetSynciv,
  Ae: _emscripten_glGetTexParameterfv,
  ze: _emscripten_glGetTexParameteriv,
  ye: _emscripten_glGetTransformFeedbackVarying,
  xe: _emscripten_glGetUniformBlockIndex,
  we: _emscripten_glGetUniformIndices,
  ve: _emscripten_glGetUniformLocation,
  ue: _emscripten_glGetUniformfv,
  te: _emscripten_glGetUniformiv,
  se: _emscripten_glGetUniformuiv,
  re: _emscripten_glGetVertexAttribIiv,
  qe: _emscripten_glGetVertexAttribIuiv,
  pe: _emscripten_glGetVertexAttribPointerv,
  oe: _emscripten_glGetVertexAttribfv,
  ne: _emscripten_glGetVertexAttribiv,
  me: _emscripten_glHint,
  le: _emscripten_glInvalidateFramebuffer,
  ke: _emscripten_glInvalidateSubFramebuffer,
  je: _emscripten_glIsBuffer,
  ie: _emscripten_glIsEnabled,
  he: _emscripten_glIsFramebuffer,
  ge: _emscripten_glIsProgram,
  fe: _emscripten_glIsQuery,
  ee: _emscripten_glIsQueryEXT,
  de: _emscripten_glIsRenderbuffer,
  ce: _emscripten_glIsSampler,
  be: _emscripten_glIsShader,
  ae: _emscripten_glIsSync,
  $d: _emscripten_glIsTexture,
  _d: _emscripten_glIsTransformFeedback,
  Zd: _emscripten_glIsVertexArray,
  Yd: _emscripten_glIsVertexArrayOES,
  Xd: _emscripten_glLineWidth,
  Wd: _emscripten_glLinkProgram,
  Vd: _emscripten_glPauseTransformFeedback,
  Ud: _emscripten_glPixelStorei,
  Td: _emscripten_glPolygonOffset,
  Sd: _emscripten_glProgramBinary,
  Rd: _emscripten_glProgramParameteri,
  Qd: _emscripten_glQueryCounterEXT,
  Pd: _emscripten_glReadBuffer,
  Od: _emscripten_glReadPixels,
  Nd: _emscripten_glReleaseShaderCompiler,
  Md: _emscripten_glRenderbufferStorage,
  Ld: _emscripten_glRenderbufferStorageMultisample,
  Kd: _emscripten_glResumeTransformFeedback,
  Jd: _emscripten_glSampleCoverage,
  Id: _emscripten_glSamplerParameterf,
  Hd: _emscripten_glSamplerParameterfv,
  Gd: _emscripten_glSamplerParameteri,
  Fd: _emscripten_glSamplerParameteriv,
  Ed: _emscripten_glScissor,
  Dd: _emscripten_glShaderBinary,
  Cd: _emscripten_glShaderSource,
  Bd: _emscripten_glStencilFunc,
  Ad: _emscripten_glStencilFuncSeparate,
  zd: _emscripten_glStencilMask,
  yd: _emscripten_glStencilMaskSeparate,
  xd: _emscripten_glStencilOp,
  wd: _emscripten_glStencilOpSeparate,
  vd: _emscripten_glTexImage2D,
  ud: _emscripten_glTexImage3D,
  td: _emscripten_glTexParameterf,
  sd: _emscripten_glTexParameterfv,
  rd: _emscripten_glTexParameteri,
  qd: _emscripten_glTexParameteriv,
  pd: _emscripten_glTexStorage2D,
  od: _emscripten_glTexStorage3D,
  nd: _emscripten_glTexSubImage2D,
  md: _emscripten_glTexSubImage3D,
  ld: _emscripten_glTransformFeedbackVaryings,
  kd: _emscripten_glUniform1f,
  jd: _emscripten_glUniform1fv,
  id: _emscripten_glUniform1i,
  hd: _emscripten_glUniform1iv,
  gd: _emscripten_glUniform1ui,
  fd: _emscripten_glUniform1uiv,
  ed: _emscripten_glUniform2f,
  dd: _emscripten_glUniform2fv,
  cd: _emscripten_glUniform2i,
  bd: _emscripten_glUniform2iv,
  ad: _emscripten_glUniform2ui,
  $c: _emscripten_glUniform2uiv,
  _c: _emscripten_glUniform3f,
  Zc: _emscripten_glUniform3fv,
  Yc: _emscripten_glUniform3i,
  Xc: _emscripten_glUniform3iv,
  Wc: _emscripten_glUniform3ui,
  Vc: _emscripten_glUniform3uiv,
  Uc: _emscripten_glUniform4f,
  Tc: _emscripten_glUniform4fv,
  Sc: _emscripten_glUniform4i,
  Rc: _emscripten_glUniform4iv,
  Qc: _emscripten_glUniform4ui,
  Pc: _emscripten_glUniform4uiv,
  Oc: _emscripten_glUniformBlockBinding,
  Nc: _emscripten_glUniformMatrix2fv,
  Mc: _emscripten_glUniformMatrix2x3fv,
  Lc: _emscripten_glUniformMatrix2x4fv,
  Kc: _emscripten_glUniformMatrix3fv,
  Jc: _emscripten_glUniformMatrix3x2fv,
  Ic: _emscripten_glUniformMatrix3x4fv,
  Hc: _emscripten_glUniformMatrix4fv,
  Gc: _emscripten_glUniformMatrix4x2fv,
  ...
  zc: _emscripten_glVertexAttrib2fv,
  yc: _emscripten_glVertexAttrib3f,
  xc: _emscripten_glVertexAttrib3fv,
  wc: _emscripten_glVertexAttrib4f,
  vc: _emscripten_glVertexAttrib4fv,
  uc: _emscripten_glVertexAttribDivisor,
  tc: _emscripten_glVertexAttribDivisorANGLE,
  sc: _emscripten_glVertexAttribDivisorARB,
  rc: _emscripten_glVertexAttribDivisorEXT,
  qc: _emscripten_glVertexAttribDivisorNV,
  pc: _emscripten_glVertexAttribI4i,
  oc: _emscripten_glVertexAttribI4iv,
  nc: _emscripten_glVertexAttribI4ui,
  mc: _emscripten_glVertexAttribI4uiv,
  lc: _emscripten_glVertexAttribIPointer,
  kc: _emscripten_glVertexAttribPointer,
  jc: _emscripten_glViewport,
  ic: _emscripten_glWaitSync,
  hc: _emscripten_memcpy_js,
  gc: _emscripten_pause_main_loop,
  ...
  dc: _emscripten_websocket_delete,
  cc: _emscripten_websocket_new,
  bc: _emscripten_websocket_send_binary,
  ac: _emscripten_websocket_send_utf8_text,
  $b: _emscripten_websocket_set_onclose_callback_on_thread,
  _b: _emscripten_websocket_set_onerror_callback_on_thread,
  Zb: _emscripten_websocket_set_onmessage_callback_on_thread,
  Yb: _emscripten_websocket_set_onopen_callback_on_thread,
  Ch: _environ_get,
  Bh: _environ_sizes_get,
  V: _exit,
  H: _fd_close,
  sa: _fd_read,
  Aa: _fd_seek,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Wh"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Xh"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Yh"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["Zh"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["_h"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["ai"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["bi"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["ci"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["di"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["ei"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["fi"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["gi"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["hi"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["ii"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["ji"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["ki"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["li"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["mi"])(a0, a1);
};
